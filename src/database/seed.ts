...
// Gurugram Road Width FAR (affects FAR based on road width as per DTCP Haryana)
const gurugramRoadWidthRules = [
  { minRoadWidth: 0, maxRoadWidth: 9, far: 1.5, notes: 'Road < 9m' },
  { minRoadWidth: 9, maxRoadWidth: 12, far: 1.75, notes: 'Road 9-12m' },
  { minRoadWidth: 12, maxRoadWidth: 18, far: 2.0, notes: 'Road 12-18m' },
  { minRoadWidth: 18, maxRoadWidth: 24, far: 2.25, notes: 'Road 18-24m' },
  { minRoadWidth: 24, maxRoadWidth: null, far: 2.5, notes: 'Road > 24m' },
];
...
// Basement Rules (common structure)
const basementRules = {
  delhi: {
    allowed: true,
    countedInFar: false,
    ...
    notes: 'Basement not counted in FAR if used for permitted purposes only',
  },
  noida: {
    allowed: true,
    countedInFar: false,
  ...
  gurugram: {
    ...
    minHeight: 2.4,
    maxHeight: 4.0,
    allowedUses: ['parking', 'storage', 'servant quarter'],
    notes: 'Double basement allowed for plots > 500 sqm',
  },
  ghaziabad: {
    allowed: true,
    countedInFar: false,
  ...
  faridabad: {
    ...
    maxHeight: 4.0,
    allowedUses: ['parking', 'storage', 'servant quarter'],
    notes: 'Similar to Gurugram regulations',
  },
};
...
const stiltRules = {
  ...
  gurugram: {
    ...
    minHeight: 2.4,
    mandatory: false,
    notes: 'Stilt parking encouraged',
  },
  ghaziabad: {
    allowed: true,
    countedInFar: false,
